...
public class Camera2BasicFragment extends Fragment
     ...
     */
    public static String CAMERA_FACING_BACK = "0";
    public static String CAMERA_FACING_FRONT = "1";
    ...
    private OnTakePictureCallBack listener;
...
//        }
    ...
    public static Camera2BasicFragment newInstance(OnTakePictureCallBack listener) {
        return new Camera2BasicFragment(listener);
    }
    ...
    Camera2BasicFragment(OnTakePictureCallBack listener) {
    ...
    private void setUpCameraOutputs(String strCameraId, int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                if (!cameraId.equalsIgnoreCase(strCameraId))
                    continue;
...
//                captureBuilder.set(CaptureRequest.FLASH_MODE, CameraMetadata.FLASH_MODE_OFF);
    ...
    public void changeTorch(boolean isFlash) {
